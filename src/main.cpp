...
int main() {
    ...
    registry->addComponent(unitGridPosition,
                           unitEntityID);                    // unused, to add with instancing
    ...
    registry->addComponent(buildingGridPosition,
                           buildingEntityID); // unused, to add with instancing
