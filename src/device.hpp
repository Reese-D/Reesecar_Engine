...
class device {
  public:
    ...
    VkQueue getGraphicsDeviceQueue(VkDevice logicalDevice, queue::QueueFamilyIndices indices);
    VkQueue getPresentDeviceQueue(VkDevice logicalDevice, queue::QueueFamilyIndices indices);
