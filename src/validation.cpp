...
validation::validation(std::shared_ptr<VkInstance> instance, const std::vector<const char *> validationLayers) : initializedInstance_(instance), validationLayers_(validationLayers) {
